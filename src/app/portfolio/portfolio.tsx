...
import { fadeInUp, slideInLeft, slideInRight, staggerContainer, scaleIn } from '@/lib/framer-motion/variants'
...
export default function Portfolio() {
  ...
  return (
    <div className='min-h-screen bg-background'>
      {/* Hero Section */}
      <section className='relative py-12 sm:py-16 md:py-20 px-4 sm:px-6 bg-gradient-to-br from-primary/5 via-background sm:bg-accent to-secondary/5 overflow-hidden'>
          ...
          <div className='grid lg:grid-cols-2 gap-8 md:gap-12 items-center'>
            ...
            >
              <div className='space-y-3 sm:space-y-4'>
                <motion.h1 className='text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight' variants={fadeInUp}>
                  Xin chào, tôi là <span className='text-primary block mt-2'>Nguyễn Trung Hiếu</span>
                </motion.h1>
                <motion.p className='text-lg sm:text-xl text-muted-foreground' variants={fadeInUp}>
                  Frontend Developer | React & UI Enthusiast
                </motion.p>

                <motion.p className='text-base sm:text-lg leading-relaxed' variants={fadeInUp}>
              ...
              <motion.div className='flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4' variants={fadeInUp}>
          ...
          >
            ...
            <motion.div variants={fadeInUp} whileHover={{ y: -10 }} transition={{ duration: 0.3 }}>
              <Card>
                ...
                <CardContent>
                  <p className='text-muted-foreground text-sm sm:text-base'>
                    Phát triển ứng dụng di động đa nền tảng với React Native. Tạo trải nghiệm native mượt mà cho cả iOS
                    và Android.
                  </p>
                </CardContent>
              </Card>
            ...
            <motion.div variants={fadeInUp} whileHover={{ y: -10 }} transition={{ duration: 0.3 }}>
              <Card className='sm:col-span-2 lg:col-span-1'>
                ...
                <CardContent>
                  <p className='text-muted-foreground text-sm sm:text-base'>
                    Chuyển đổi designs từ Figma thành mã nguồn. Tích hợp RESTful APIs, GraphQL và quản lý state hiệu
                    quả.
                  </p>
                </CardContent>
              </Card>
      ...
      <section className='py-12 sm:py-16 md:py-20 px-4 sm:px-6 bg-gradient-to-br from-primary/5 via-background to-secondary/5 text-center'>
        <div className='max-w-6xl mx-auto'>
          ...
          <motion.div
            className='grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-7 gap-4 sm:gap-6 md:gap-8 place-items-center'
            initial='hidden'
            whileInView='visible'
            viewport={{ once: true, amount: 0.2 }}
            variants={staggerContainer}
